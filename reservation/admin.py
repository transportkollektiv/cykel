...
class ReservationAdmin(admin.ModelAdmin):
    ...
    search_fields = ("start_location__station_name", "vehicle_type__name", "creator__username")

    def get_list_display(self, request):
        if request.user.has_perm("cykel.view_user"):
            return ("id", "bike", "get_creator", "get_event_start", "get_event_end", "start_location", "vehicle_type")
        return ("id", "bike", "get_event_start", "get_event_end", "start_location", "vehicle_type")
